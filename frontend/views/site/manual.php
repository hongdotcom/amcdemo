          ...
          <div class="col-md-12">
            <div class="card animated materialUp animation-delay-5">
                <div class="card-body card-body-big ">
                    <h1 class="no-mt ">Contractor, Supplies & Venue</h1>
                    <div class="mb-4 ">
                        <img src="/img/demo/avatar/50.jpg " alt="... " class="img-circle mr-1 "> by <a href="javascript:void(0) ">Victoria</a> in <a href="javascript:void(0) " class="ms-tag ms-tag-info ">Design</a>
                        <span class="ml-1 d-none d-sm-inline "><i class="zmdi zmdi-time mr-05 color-info "></i> <span class="color-medium-dark ">November 14-16, 2018</span></span>
                        <span class="ml-1 "><i class="zmdi zmdi-comments color-royal mr-05 "></i> 25</span>
                    </div>
                    <img src="/img/demo/banner.jpg " alt=" " class="img-fluid mb-4">
                    ...
                    <h3 class="color-primary ">Special Guest from Hollywood</h3>
                    ...
                    <img src="/img/demo/avatar/2.jpg " alt=" " class="imgborder ml-2 mb-2 pull-right ">
