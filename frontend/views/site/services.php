...
<header class="ms-hero-page ms-hero-bg-dark-light ms-hero-img-city2 mb-4 ms-bg-fixed">
    <div class="container">
            ...
            <div class="col-lg-4 col-sm-6 mb-2">
                <div class="ms-icon-feature wow flipInX animation-delay-4" style="visibility: visible; animation-name: flipInX;">
                    ...
                    <div class="ms-icon-feature-content color-white">
                        <h4 class="color-info">Cloud Computing</h4>
        ...
        <div class="text-center">
            <a href="javascript:void(0)" class="btn btn-raised btn-white color-royal animated fadeInUp animation-delay-10">
                <i class="zmdi zmdi-desktop-mac"></i> Portfolio</a>
            <a href="javascript:void(0)" class="btn btn-raised btn-white color-success animated fadeInUp animation-delay-10">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="text-center center-block">
                                <img src="/img/demo/office1.jpg" alt="" class="img-fluid"> </div>
                        </div>
                        <div class="col-lg-8 text-center">
                            <h4 class="color-primary mt-lg-0">Lorem ipsum dolor sit amet</h4>
            ...
            <div class="card card-primary-inverse mb-4">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="text-center center-block">
                                <img src="/img/demo/office3.jpg" alt="" class="img-fluid"> </div>
                        </div>
                        <div class="col-lg-8 text-center">
                            <h4 class="mt-lg-0">Lorem ipsum dolor sit amet</h4>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cumque, alias similique sapiente rerum ipsam delectus corporis.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-primary mb-4">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="text-center center-block">
                                <img src="/img/demo/office2.jpg" alt="" class="img-fluid"> </div>
                        </div>
                        <div class="col-lg-8 text-center">
                            <h4 class="color-primary mt-lg-0">Lorem ipsum dolor sit amet</h4>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cumque, alias similique sapiente rerum ipsam delectus corporis.</p>
            ...
            <div class="card card-primary-inverse mb-4">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="text-center center-block">
                                <img src="/img/demo/office4.jpg" alt="" class="img-fluid"> </div>
                        </div>
                        <div class="col-lg-8 text-center">
                            <h4 class="mt-lg-0">Lorem ipsum dolor sit amet</h4>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cumque, alias similique sapiente rerum ipsam delectus corporis.</p>
