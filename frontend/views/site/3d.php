...
use frontend\assets\Builder3DAsset;
use yii\helpers\Url;

Builder3DAsset::register($this);
?>
<div class="container-fluid" style="margin-top: -30px !important;">
    <div class="row main-row">
        <!-- Left Column -->
        <div class="col-md-3 col-sm-12 sidebar">
            <h1>Trade Stand Editor</h1>
            <div class="list-group">
                <li class="list-group-item" id="floorplan_tab"><a href="#">Edit Floorplan</a></li>
                <li class="list-group-item" id="design_tab"><a href="#">Design</a></li>
                <li class="list-group-item" id="items_tab"><a href="#">Add Items</a></li>
            </div>
        ...
        <div class="col-md-3">
            <div class="card-header">
                <h4 class="text-success"><i class="fa fa-2x fa-briefcase"></i> Your Furniture & Equipments</h4>
            </div>
            <div class="card-body">
