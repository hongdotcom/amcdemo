...
(function (BP3D) {
    ...
    (function (Model) {
        ...
        class Floorplan {
            ...
            floorPlanes() {
                return BP3D.Core.Utils.map(this.rooms, (room) => {
...
(function (BP3D) {
    ...
    (function (Items) {
         ...
         */
        class FloorItem extends Items.Item {
            constructor(model, metadata, geometry, material, position, rotation, scale) {
...
(function (BP3D) {
    ...
    (function (Items) {
         ...
         */
        class WallItem extends Items.Item {
            constructor(model, metadata, geometry, material, position, rotation, scale) {
                super(model, metadata, geometry, material, position, rotation, scale);
...
(function (BP3D) {
    ...
    (function (Items) {
        /** */
        class InWallItem extends Items.WallItem {
            constructor(model, metadata, geometry, material, position, rotation, scale) {
                super(model, metadata, geometry, material, position, rotation, scale);
                this.addToWall = true;
            }
...
(function (BP3D) {
    ...
    (function (Items) {
        /** */
        class InWallFloorItem extends Items.InWallItem {
            constructor(model, metadata, geometry, material, position, rotation, scale) {
                super(model, metadata, geometry, material, position, rotation, scale);
...
(function (BP3D) {
    ...
    (function (Items) {
        /** */
        class OnFloorItem extends Items.FloorItem {
            constructor(model, metadata, geometry, material, position, rotation, scale) {
                super(model, metadata, geometry, material, position, rotation, scale);
...
(function (BP3D) {
    ...
    (function (Items) {
        /** */
        class WallFloorItem extends Items.WallItem {
            constructor(model, metadata, geometry, material, position, rotation, scale) {
                super(model, metadata, geometry, material, position, rotation, scale);
                this.boundToFloor = true;
            }
        ...
        class Scene {
            ...
            addItem(itemType, fileName, metadata, position, rotation, scale, fixed) {
                ...
                var loaderCallback = function (geometry, materials) {
                    var item = new (BP3D.Items.Factory.getClass(itemType))(scope.model, metadata, geometry, new THREE.MultiMaterial(materials), position, rotation, scale);
...
(function (BP3D) {
    ...
    (function (Floorplanner) {
        ...
        class FloorplannerView {
            ...
            drawRoom(room) {
                var scope = this;
                this.drawPolygon(BP3D.Core.Utils.map(room.corners, (corner) => {
                    return scope.viewmodel.convertX(corner.x);
                }), BP3D.Core.Utils.map(room.corners, (corner) => {
                    return scope.viewmodel.convertY(corner.y);
                }), true, roomColor);
            }
            /** */
